...
public class Main {
    public static void main(String[] args) {
        ...
        invoice1.addProduct(new Music("Submarine", 101, 20.0, "Rock", 1968, 5, 100, "The Beatles"));
        invoice1.addProduct(new Music("AM", 102, 10.0, "Indie Rock", 2013, 10, 10, "Arctic Monkeys"));
        invoice1.addProduct(new Movie("Good Will Hunting", 201, 12.0, "Drama", 1997, 2, 125, "Gus Van Sant"));
        invoice1.addProduct(new Movie("Life Is Beautiful", 202, 20.0, "Comedy", 1997, 0, 125, "Roberto Benigni"));
        invoice1.addProduct(new Game("Red Dead Redemption 2", 301, 29.0, "Action-Adventure", 2018, 15, 560, "Rockstar Games"));
