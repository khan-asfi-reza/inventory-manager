...
public class Invoice {
    ...
    // Check if all categories have at least two items, if all categories have at least two items
    // then full house discount will be applicable
